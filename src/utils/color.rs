//! Utility facilities for colors.
//!
//! Various utility facilities designed to help with
...
impl RGB {
    /// Takes a given hexadecimal color code (e.g. #1db954) and splits it off
    /// into individial integers matching the R, G, and B color specification.
    ///
    /// Returns a Result containing said integers, or returns a [ParseIntError]
    ...
    /// Takes the provided R, G, and B integers (e.g. 43, 116, 137), and converts
    /// them to a hexadecimal color code.
    ///
    /// # Example
    /// ```
